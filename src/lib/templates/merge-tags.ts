...
export const LOAN_FIELDS = [
  ...
  'savingsFirstDepositDateLong',
  'savingsLastDepositDate',
  'savingsLastDepositDateLong',
  'savingsSummary',
...
export const FIELD_TYPES: Record<string, FieldType> = {
  ...
  'loan.isSavingsContract': 'boolean',
  'loan.savingsRateType': 'enum',
  'loan.savingsMonthlyAmount': 'currency',
  'loan.savingsDepositCount': 'number',
  'loan.savingsFirstDepositDate': 'date',
  'loan.savingsFirstDepositDateLong': 'date',
  'loan.savingsLastDepositDate': 'date',
  'loan.savingsLastDepositDateLong': 'date',
  'loan.savingsSummary': 'string',
  'loan.status': 'enum',
  'loan.balance': 'currency',
  'loan.interest': 'currency',
  'loan.deposits': 'currency',
  'loan.depositsCount': 'number',
  'loan.savingsPaymentStatus': 'string',
